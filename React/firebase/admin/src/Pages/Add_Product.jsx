...
function Add_Product() {
  ...
  {
      e.preventDefault();
      const res= await axios.post('https://adeeba-87361-default-rtdb.firebaseio.com/product.json',formvalue);
      if(res.status==200)
      {
          ...
          <div className="panel panel-primary">
            ...
            <div className="panel-body">
              ...
              <div className="form-group">
                ...
                <input type="url" className="form-control" name="file" value={formvalue.file} onChange={changehandel}/>
              </div>
