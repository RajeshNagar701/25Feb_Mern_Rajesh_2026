                            ...
                            <div className="col-md-6  ">
                                <div className="box ">
                                    <div className="img-box">
                                        <img src="website/images/o1.jpg" alt />
                                    </div>
                        ...
                        <div className="row grid">
                            <div className="col-sm-6 col-lg-4 all pizza">
                                <div className="box">
                                    <div>
                                        <div className="img-box">
                                            <img src="website/images/f1.png" alt />
                                        </div>
                                        <div className="detail-box">
                                            <h5>
                                                Delicious Pizza
                   ...
                   c1.024,28.16,24.064,50.688,52.224,50.688h1.024C193.536,443.31,216.576,418.734,215.04,389.55z" />
                            ...
                            <div className="col-sm-6 col-lg-4 all burger">
                                <div className="box">
                                    <div>
                                        <div className="img-box">
                                            <img src="website/images/f2.png" alt />
                                        </div>
                                        <div className="detail-box">
                                            <h5>
                                                Delicious Burger
                   ...
                   c1.024,28.16,24.064,50.688,52.224,50.688h1.024C193.536,443.31,216.576,418.734,215.04,389.55z" />
                            ...
                            <div className="col-sm-6 col-lg-4 all pizza">
                                <div className="box">
                                    <div>
                                        <div className="img-box">
                                            <img src="website/images/f3.png" alt />
                                        </div>
                                        <div className="detail-box">
                                            <h5>
                                                Delicious Pizza
                   ...
                   c1.024,28.16,24.064,50.688,52.224,50.688h1.024C193.536,443.31,216.576,418.734,215.04,389.55z" />
                            ...
                            <div className="col-sm-6 col-lg-4 all pasta">
                                <div className="box">
                                    <div>
                                        <div className="img-box">
                                            <img src="website/images/f4.png" alt />
                                        </div>
                                        <div className="detail-box">
                                            <h5>
                                                Delicious Pasta
                   ...
                   c1.024,28.16,24.064,50.688,52.224,50.688h1.024C193.536,443.31,216.576,418.734,215.04,389.55z" />
                            ...
                            <div className="col-sm-6 col-lg-4 all fries">
                                <div className="box">
                                    <div>
                                        <div className="img-box">
                                            <img src="website/images/f5.png" alt />
                                        </div>
                                        <div className="detail-box">
                                            <h5>
                                                French Fries
                   ...
                   c1.024,28.16,24.064,50.688,52.224,50.688h1.024C193.536,443.31,216.576,418.734,215.04,389.55z" />
                            ...
                            <div className="col-sm-6 col-lg-4 all pizza">
                                <div className="box">
                                    <div>
                                        <div className="img-box">
                                            <img src="website/images/f6.png" alt />
                                        </div>
                                        <div className="detail-box">
                                            <h5>
                                                Delicious Pizza
                   ...
                   c1.024,28.16,24.064,50.688,52.224,50.688h1.024C193.536,443.31,216.576,418.734,215.04,389.55z" />
                            ...
                            <div className="col-sm-6 col-lg-4 all burger">
                                <div className="box">
                                    <div>
                                        <div className="img-box">
                                            <img src="website/images/f7.png" alt />
                                        </div>
                                        <div className="detail-box">
                                            <h5>
                                                Tasty Burger
                   ...
                   c1.024,28.16,24.064,50.688,52.224,50.688h1.024C193.536,443.31,216.576,418.734,215.04,389.55z" />
                            ...
                            <div className="col-sm-6 col-lg-4 all burger">
                                <div className="box">
                                    <div>
                                        <div className="img-box">
                                            <img src="website/images/f8.png" alt />
                                        </div>
                                        <div className="detail-box">
                                            <h5>
                                                Tasty Burger
                   ...
                   c1.024,28.16,24.064,50.688,52.224,50.688h1.024C193.536,443.31,216.576,418.734,215.04,389.55z" />
                            ...
                            <div className="col-sm-6 col-lg-4 all pasta">
                                <div className="box">
                                    <div>
                                        <div className="img-box">
                                            <img src="website/images/f9.png" alt />
                                        </div>
                                        <div className="detail-box">
                                            <h5>
                                                Delicious Pasta
                        ...
                        <div className="owl-carousel client_owl-carousel">
                            <div className="item">
                                <div className="box">
                                    ...
                                    <div className="img-box">
                                        <img src="website/images/client1.jpg" alt className="box-img" />
                                    </div>
                                </div>
                            </div>
                            <div className="item">
                                <div className="box">
                                    ...
                                    <div className="img-box">
                                        <img src="website/images/client2.jpg" alt className="box-img" />
                                    </div>
                                </div>
                            </div>
                        </div>
